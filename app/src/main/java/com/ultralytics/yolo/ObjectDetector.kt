    ...
    companion object {
        ...
        init {
            try {
                ...
                Log.d(TAG, "Native library 'ultralytics' loaded successfully")
            } catch (e: UnsatisfiedLinkError) {
                Log.e(TAG, "Failed to load native library 'ultralytics'", e)
                e.printStackTrace()
                throw e
            } catch (e: Exception) {
                Log.e(TAG, "Exception while loading native library", e)
                e.printStackTrace()
                throw e
            }
        }
